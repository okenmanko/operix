...
export default function DebtsPage() {
  ...
  async function exportExcel() {
    try {
      await downloadFileSafe("/clients/export-excel", "QARZ13-operix-export.xlsx");
    } catch (err: unknown) {
  ...
  return (
    <AppLayout title="Qarzlar" subtitle="Mijoz qarzlari, muddatlar va to‘lov holati.">
      {error ? (
      ...
      <div className="premium-card mb-5 p-5">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-[13px] text-[#8aa0ba]">Qarz qo‘shish, import, filtrlash va Excel export.</p>
          </div>
